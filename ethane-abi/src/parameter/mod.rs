...
mod test {
    ...
    fn decode_parameter() {
        ...
        assert_eq!(a.to_string(), String::from("0xaff")); // decimal: 2815
        assert_eq!(b.to_string(), String::from("0xbff")); // decimal: 3071
        assert_eq!(c.to_string(), String::from("0xcff")); // decimal: 3327
    }
}
